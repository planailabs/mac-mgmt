...
nav-fleet = Flotte
nav-healer-spend = Healer-Kosten
...
cluster-detail-group-access = Zugangstokens
cluster-detail-group-config = Konfiguration
cluster-detail-group-skills = Skills & MCP
cluster-detail-group-operations = Pakete & Betrieb
...
cluster-mcp-via = über { $source } MCP Center
...
cluster-skills-via = über { $source } Skill Center
...
fleet-kpi-online = Online-Instanzen
fleet-kpi-services-healthy = Funktionierende Dienste
fleet-kpi-clusters = Cluster
fleet-kpi-failing-probes = Fehlgeschlagene Proben
...
fleet-detail-stat-cpu = CPU-Last
fleet-detail-stat-cpu-sub = 1m Mittel
fleet-detail-stat-memory = Speicher
fleet-detail-stat-net-rx = Netz RX
fleet-detail-stat-net-tx = Netz TX
fleet-detail-stat-net-sub = seit Boot
...
rollout-form-ramp-label = Ramp-Dauer (Minuten)
rollout-form-ramp-help = Jede Stufe schrittweise ausrollen: Über diese Anzahl Minuten ab Stufenstart wird ein wachsender Anteil der Cluster der Gruppe für das Ziel freigeschaltet. Leer lassen, um jede Stufe auf einmal auszurollen.
rollout-form-ramp-placeholder = z.B. 60
...
rollout-detail-ramp = Ramp: { $pct } % freigeschaltet ({ $mins } Min. Fenster)
...
rollout-detail-delivered = Ausgelieferte Cluster ({ $count })
rollout-detail-delivered-help = Diese Cluster haben das Ziel dieses Rollouts abgerufen und erhalten es für die gesamte Lebensdauer des Rollouts weiter, auch während einer Pause oder Sperre.
...
skill-center-form-name-placeholder = Name des Skill Centers
...
import-source-config = Quell-Konfiguration
...
# ── Healer-Kosten-Dashboard ──
healer-spend-title = Healer-Kosten
healer-spend-subtitle = Token-Verbrauch und geschätzte Kosten pro Modell, letzte { $days } Tage
healer-spend-kpi-total = Tokens gesamt ({ $days } T)
healer-spend-kpi-input = Input-Tokens
healer-spend-kpi-output = Output-Tokens
healer-spend-kpi-cost = Gesch. Kosten ({ $days } T)
healer-spend-kpi-sessions = Sitzungen
healer-spend-models-title = Aufschlüsselung pro Modell
healer-spend-empty = In diesem Zeitraum wurde noch kein Token-Verbrauch erfasst.
healer-spend-col-model = Modell
healer-spend-col-role = Rolle
healer-spend-col-input = Input
healer-spend-col-output = Output
healer-spend-col-sessions = Sitzungen
healer-spend-col-cost = Gesch. Kosten
healer-spend-col-trend = Verlauf ({ $days } T)
healer-spend-col-last-used = Zuletzt genutzt
healer-spend-role-model = Modell
healer-spend-role-validator = Validator
healer-spend-role-removed = entfernt
healer-spend-never-used = nie
...
chat-menu = Chat-Menü
chat-back-to-list = Zurück zu den Sitzungen
chat-new = Neuer Chat
chat-start = Starten
chat-refresh = Aktualisieren
chat-send = Senden
chat-untitled = Unbenannter Chat
chat-no-sessions = Noch keine Chats — stelle dem Flotten-Assistenten unten eine Frage.
chat-first-message-placeholder = Frag zur Flotte oder sag dem Assistenten, was geändert werden soll…
chat-input-placeholder = Antworten… (Enter zum Senden, Shift+Enter für Zeilenumbruch)
chat-input-queued-placeholder = Agent arbeitet — deine Nachricht wird eingereiht…
chat-session-over = Diese Sitzung ist beendet.
chat-session-title = Chat-Sitzung
chat-disabled = Chat ist auf diesem Server nicht aktiviert.
chat-pinned = Angeheftet
chat-pause = Sitzung pausieren
chat-cancel = Sitzung abbrechen
chat-extend-budget = Mehr Tokens
chat-auto-approve = automatisch genehmigen
chat-approval-needed = möchte ausführen — Genehmigung erforderlich
chat-approve-once = Genehmigen
chat-approve-all = Alle genehmigen
chat-deny = Ablehnen
