...
ai-spend-title = KI-Kosten
ai-spend-subtitle = Token-Verbrauch und geschätzte Kosten pro Modell, letzte { $days } Tage
ai-spend-kpi-total = Tokens gesamt ({ $days } T)
ai-spend-kpi-input = Input-Tokens
ai-spend-kpi-output = Output-Tokens
ai-spend-kpi-cost = Gesch. Kosten ({ $days } T)
ai-spend-kpi-sessions = Sitzungen
ai-spend-models-title = Aufschlüsselung pro Modell
ai-spend-empty = In diesem Zeitraum wurde noch kein Token-Verbrauch erfasst.
ai-spend-col-model = Modell
ai-spend-col-role = Rolle
ai-spend-col-input = Input
ai-spend-col-output = Output
ai-spend-col-sessions = Sitzungen
ai-spend-col-cost = Gesch. Kosten
ai-spend-col-trend = Verlauf ({ $days } T)
ai-spend-col-last-used = Zuletzt genutzt
ai-spend-role-model = Modell
ai-spend-role-validator = Validator
ai-spend-role-removed = entfernt
ai-spend-never-used = nie
