...
# ── AI spend dashboard ──
ai-spend-title = AI Spend
ai-spend-subtitle = Token usage and estimated cost per model, last { $days } days
ai-spend-kpi-total = Total tokens ({ $days }d)
ai-spend-kpi-input = Input tokens
ai-spend-kpi-output = Output tokens
ai-spend-kpi-cost = Est. spend ({ $days }d)
ai-spend-kpi-sessions = Sessions
ai-spend-models-title = Per-model breakdown
ai-spend-empty = No token usage recorded in this window yet.
ai-spend-col-model = Model
ai-spend-col-role = Role
ai-spend-col-input = Input
ai-spend-col-output = Output
ai-spend-col-sessions = Sessions
ai-spend-col-cost = Est. cost
ai-spend-col-trend = Trend ({ $days }d)
ai-spend-col-last-used = Last used
ai-spend-role-model = model
ai-spend-role-validator = validator
ai-spend-role-removed = removed
ai-spend-never-used = never
