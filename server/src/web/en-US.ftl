...
healer-spend-title = Healer Spend
healer-spend-subtitle = Token usage and estimated cost per model, last { $days } days
healer-spend-kpi-total = Total tokens ({ $days }d)
healer-spend-kpi-input = Input tokens
healer-spend-kpi-output = Output tokens
healer-spend-kpi-cost = Est. spend ({ $days }d)
healer-spend-kpi-sessions = Sessions
healer-spend-models-title = Per-model breakdown
healer-spend-empty = No token usage recorded in this window yet.
healer-spend-col-model = Model
healer-spend-col-role = Role
healer-spend-col-input = Input
healer-spend-col-output = Output
healer-spend-col-sessions = Sessions
healer-spend-col-cost = Est. cost
healer-spend-col-trend = Trend ({ $days }d)
healer-spend-col-last-used = Last used
healer-spend-role-model = model
healer-spend-role-validator = validator
healer-spend-role-removed = removed
healer-spend-never-used = never
...
chat-menu = Chat menu
chat-back-to-list = Back to sessions
chat-new = New chat
chat-start = Start
chat-refresh = Refresh
chat-send = Send
chat-untitled = Untitled chat
chat-no-sessions = No chats yet — ask the fleet assistant anything below.
chat-first-message-placeholder = Ask about your fleet, or tell the assistant what to change…
chat-input-placeholder = Reply… (Enter to send, Shift+Enter for newline)
chat-input-queued-placeholder = Agent is working — your message will be queued…
chat-session-over = This session has ended.
chat-session-title = Chat session
chat-disabled = Chat is not enabled on this server.
chat-pinned = Pinned
chat-pause = Pause session
chat-cancel = Cancel session
chat-extend-budget = More tokens
chat-auto-approve = auto-approve
chat-approval-needed = wants to run — approval needed
chat-approve-once = Approve
chat-approve-all = Approve all
chat-deny = Deny
chat-deny-reason-placeholder = Reason (optional)
chat-guard-verdict = Guard verdict
chat-state-running = running
chat-state-planning = planning
chat-state-executing = executing
chat-state-executed = executed
docs-glossary = Glossary
glossary-search-placeholder = Search terms and definitions…
glossary-no-results = No glossary entries match.
docs-glossary-link = → Glossary of platform terms
