...
/// A bundle from a remote skill center.
...
#[server]
async fn list_remote_bundles() -> Result<Vec<RemoteBundle>, ServerFnError> {
...
pub fn BundleList() -> Element {
    ...
    let remote_bundles = use_server_future(list_remote_bundles)?;
