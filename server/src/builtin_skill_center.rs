...
pub const BUILTIN_SKILL_CENTER_ID: Uuid = Uuid::from_bytes([
    0x00, 0xb1, 0x71, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
]);

/// Well-known UUID for the plan-ai-cleaner MCP server.
const CLEANER_ID: Uuid = Uuid::from_bytes([
    0x00, 0xb1, 0x71, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
]);

/// Well-known UUID for the plan-ai-cloud MCP server.
const CLOUD_ID: Uuid = Uuid::from_bytes([
    0x00, 0xb1, 0x71, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03,
]);

/// Well-known UUID for the built-in MCP bundle.
const MCP_BUNDLE_ID: Uuid = Uuid::from_bytes([
    0x00, 0xb1, 0x71, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
]);

/// Well-known UUID for the plan-ai-memvault MCP server.
const MEMVAULT_ID: Uuid = Uuid::from_bytes([
    0x00, 0xb1, 0x71, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05,
]);

/// Well-known UUID for the built-in skills bundle.
const SKILLS_BUNDLE_ID: Uuid = Uuid::from_bytes([
    0x00, 0xb1, 0x71, 0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06,
]);
...
pub fn resolve_builtin_skills(slug_channels: &[(String, String)]) -> HashMap<String, String> {
