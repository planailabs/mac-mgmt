...
impl Connector for UnslothOpencode {
    ...
    fn connect(
        ...
        tracing::info!("connecting unsloth to opencode (baseUrl={base_url}, model={}, default={})", self.default_model, self.set_default);
        sentry_ext::breadcrumb(
            "connector",
            &format!("unsloth\u{2192}opencode baseUrl={base_url}"),
            &[("connector", "unsloth\u{2192}opencode"), ("base_url", &base_url), ("model", &self.default_model)],
        );
