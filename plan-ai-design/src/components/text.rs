...
#[component]
pub fn PageHeader(#[props(default, into)] class: String, children: Element) -> Element {
    rsx! { h2 { class: "h-page {class}", {children} } }
}

/// Heading for a section within a page. `.h-section` includes `mb-3`.
#[component]
pub fn SectionHeading(#[props(default, into)] class: String, children: Element) -> Element {
...
#[component]
pub fn ErrorText(#[props(default, into)] class: String, children: Element) -> Element {
    rsx! { p { class: "err {class}", {children} } }
}

/// Inline success message in success color.
#[component]
pub fn SuccessText(#[props(default, into)] class: String, children: Element) -> Element {
